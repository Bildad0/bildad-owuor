...
const ProjectCard = ({ index, name, description, tags,live_link,  image, source_code_link }) => {
  return (
    <motion.div
      ...
      >
        <div className='relative w-full h-[230px]'>
          ...
          <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
            ...
            <a className='w-10 h-10 rounded-full flex justify-center curser-pointer' href={live_link} target='_blank'>
