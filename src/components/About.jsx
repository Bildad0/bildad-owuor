...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <Tilt className='xs:w-[250px] w-content'>
      <motion.div
        variants={fadeIn("right", "spring", 0.5 * index, 0.75)}
        className='w-content green-pink-gradient p-[1px] rounded-[20px] shadow-card'
      >
...
const About = () => {
  return (
    ...
    >
      ...
      <div className='mt-20 grid grid-cols-2 gap-3 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4'>
